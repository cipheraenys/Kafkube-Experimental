...
// Konfigurasi via env PROMETHEUS_URL untuk portabilitas antar klaster.
// Default menunjuk ke service Prometheus internal pada klaster demo.
const PROMETHEUS_BASE = process.env.PROMETHEUS_URL || "http://k8s-master:30909";
const BASE_PROM = `${PROMETHEUS_BASE}/api/v1/query?query=`;
