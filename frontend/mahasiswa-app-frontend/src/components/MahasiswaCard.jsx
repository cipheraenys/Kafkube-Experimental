...
import { User, Hash, BookOpen, Calendar, Clock, Pencil, Trash2 } from 'lucide-react'

const MahasiswaCard = ({ mahasiswa, index, onEdit, onDelete, deleting }) => {
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  className="p-2 bg-white/10 hover:bg-blue-500/30 text-blue-300 hover:text-blue-200 rounded-lg transition-all duration-300 transform hover:scale-110"
                ...
                <button
                  ...
                  disabled={deleting}
                  className="p-2 bg-white/10 hover:bg-red-500/30 text-red-300 hover:text-red-200 rounded-lg transition-all duration-300 transform hover:scale-110 disabled:opacity-50 disabled:cursor-not-allowed"
